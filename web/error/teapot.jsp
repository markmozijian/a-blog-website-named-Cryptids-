    ...
    <section id="home" class="tab-pane fade in active">
        <article class="home-content">
            <header role="home-title">
                <h2>Teapot
                    <div id="typed-strings"><span>of DOOM!</span> <span>of not coffee</span> <span>of error 418</span> <span>I'm a teapot</span>
                    </div>
...
<a href="${pageContext.request.contextPath}/home-page" class="btn-start">Click to return</a>
