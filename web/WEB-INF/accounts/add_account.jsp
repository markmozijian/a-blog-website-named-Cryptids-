...
<head>
    ...
    <script>
        let check_id_url = "./check-user-id?id=";
        function check_id(id){
            ajax_get(check_id_url + id,function (responseText) {
        ...
        <div class="sign-up-form">
            <div id="sign-up-password">
                ...
                <form action="./add-account" enctype="application/x-www-form-urlencoded" method="post">
                    UserID: <span hidden class="alert-warning" id="id-warning">UserID taken</span> <br>
                    <input type="number" id="user-id" name="id"><br>
                    Username: <span class="alert-warning invisible" id="username-taken">Username taken</span><br>
                    <input type="text" id="input_username" name="username"><br>
                    Password:<br>
                    <input type="password" name="password"><br>
                    <input type="submit" class="signup-btn" value="Add account">
                </form>
