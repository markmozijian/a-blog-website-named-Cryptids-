    ...
    <div class="sectionWrapper">
        <div class="sign-up-form">
            <div id="sign-up-password">
                ...
                <c:if test="${user.ID < 0}">
                    <br>
                    <h2>Enter a username to send a reset password email to the user</h2>
                    <br>
                </c:if>
                ...
                <form method="post" action="./reset-password">
                    Username:<br>
                    <input type="text" name="username" class="inputString" value="${username}">
                    <br>
                    <input type="submit"  value="Reset" class="signup-btn">
                </form>
