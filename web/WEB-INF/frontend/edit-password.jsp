    ...
    <div class="sectionWrapper">
        <div class="sign-up-form">
            <div id="sign-up-password">
                <h1 class="profile">Edit Password</h1>

                <div class="login-password-container">
                    <form method="post" action="./edit-password" enctype="application/x-www-form-urlencoded">
                        <div id="aa">
                            Current password:<br>
                            <input type="password" name="old_password" class="inputString" >
                            <br>
                            New password:<br>
                            <input type="password" name="new_password" class="inputString">
                            <br>
                        </div>
                        <button class="signup-btn" type="submit">Update</button>
                    </form>
                </div>
            </div>
