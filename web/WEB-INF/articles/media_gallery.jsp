...
<c:if test="${user != null}">
    ...
    <button type="button" onclick="load_all_media()" class="btncustom" id="allmedia">All media</button>
    <button type="button" onclick="load_author_media(${user.ID})" class="btncustom" id="mediabtn">My media</button>
    </div>
</c:if>
...
<div id="page-content" class="single-page">
    <div class="container">
        <div class="row">
            ...
            <div id="main-content" class="edit-content" data-user-id="${user.ID}">
