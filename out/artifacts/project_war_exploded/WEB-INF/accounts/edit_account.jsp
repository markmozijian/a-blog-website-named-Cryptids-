        ...
        <div class="sign-up-form">
            <div id="sign-up-password">
                ...
                <div class="login-password-container">
                    <form method="post" action="./edit-account" enctype="multipart/form-data" onsubmit="post_ajax(this)">
                        <div id="aa">
                            Username:<span id="username-taken" class="alert-warning invisible">Username already taken</span><br>
                            <input class="inputString" name="username" id="input_username" type="text" value="${user.username}" ><br>
                            ...
                            Email:<br>
                            <input class="inputString" name="email" id="input_email" type="email" value="${user.email}"><br>
                            Real Name:<br>
                            <input class="inputString" name="realName" id="input_rlname" type="text" value="${user.realName}"><br>
                            Date of Birth:<br>
                            <input class="inputString" name="birthday" id="input_bday" type="date" value="${user.dateOfBirth}"><br>
                            Country:<br>
                            <input class="inputString" name="country" id="input_country" type="text" value="${user.country}"><br>
                            Bio:<br>
                            <input name="bio" id="hidden-form" type="hidden" value="">
                            <br>
                            ...
                            <script>
                                ...
                                function fill_quill() {
                                    ...
                                    editor[0].innerHTML = String.raw `${user.bio}`;
                                    return true;
                                }
                            </script>
                            <br>
                        </div>
                        <button class="signup-btn" type="submit">Edit</button>
                    </form>
                </div>
            </div>
