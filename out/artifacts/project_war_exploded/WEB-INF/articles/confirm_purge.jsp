    ...
    <div class="sectionWrapper">
        <div class="sign-up-form">
            <div id="sign-up-password">
                ...
                <form action="./purge_article" method="post">
                    <input type="hidden" value="${article.ID}" name="articleID">
                    <button type="submit" class="signup-btn">Yes</button>
                </form>
                <a href="./view_article?articleID=${article.ID}"><button class="signup-btnno" type="submit">No</button></a>
            </div>
