...
public class DBConnection {
    ...
    private static final String SQL_INFO = "connection.properties";
    ...
    public static Connection getDefault() throws SQLException,IOException{
        return getConnectionFromSrcFolder(SQL_INFO);
    }
